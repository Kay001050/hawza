...
لوحة الإدارة متوفرة في **admin.html** وغير مرتبطة بباقي الصفحات. بعد تشغيل الخادم وإنشاء ملف `.env` يمكنك فتح هذه الصفحة وإدخال كلمة المرور لمراجعة الأسئلة وكتابة الإجابات عليها. بعد الحفظ ستظهر الأسئلة المجابة للزوار في **questions.html**.
